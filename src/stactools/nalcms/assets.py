...
ITEM_ASSETS: Dict[str, AssetDefinition] = {
    ...
    AssetDefinition({
        ...
        "description":
        ("This map demonstrates land cover change between 2010 and 2015 "
    ...
    AssetDefinition({
        ...
        "description":
        ("This map of North American land cover at a spatial resolution of 30"
    ...
    AssetDefinition({
        ...
        "description":
        ("This map demonstrates land cover change between 2005 and 2010 in North"
    ...
    AssetDefinition({
        ...
        "description":
        ("This map of North American land cover at a spatial resolution of 250"
         " meters provides a harmonized view of the physical cover of Earth’s"
